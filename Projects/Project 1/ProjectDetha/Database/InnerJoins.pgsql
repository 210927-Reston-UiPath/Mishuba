select customers.id, customers.customername, customers.customeraddress, shoppinglist.customeritems, shoppinglist.customeritemquantity from customers inner join shoppinglist on shoppinglist.customerid=customers.id;
...
select customers.id, customername, customeraddress, customeritems, customeritemquantity, totalamount from customers, expensetotal, shoppinglist;
